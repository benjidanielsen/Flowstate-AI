...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'godmode-logs/tester-ai.log', encoding='utf-8'),
...
class TesteraiAI:
    ...
    def __init__(self):
        self.agent_name = "tester-ai"
        self.capabilities = ['unit_testing', 'integration_testing', 'performance_testing']
