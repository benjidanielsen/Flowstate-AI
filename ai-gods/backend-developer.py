...
logging.basicConfig(
    level=logging.INFO,
    format="🤖 [BACKEND-DEVELOPER] %(asctime)s - %(levelname)s - %(message)s",
    handlers=[
        logging.FileHandler(f"godmode-logs/backend-developer.log"),
