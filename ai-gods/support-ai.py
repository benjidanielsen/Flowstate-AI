...
def provide_support():
    logger.info("Support AI starting...")
    update_status("Working", "Monitoring user queries", 10)
    time.sleep(2) # Simulate work

    update_status("Working", "Troubleshooting issues", 30)
    time.sleep(3)

    update_status("Working", "Providing solutions", 60)
    time.sleep(4)

    update_status("Working", "Updating knowledge base", 90)
    time.sleep(3)

    update_status("Completed", "Support cycle complete", 100, task_duration=9)
    logger.info("Support AI finished its current task.")
